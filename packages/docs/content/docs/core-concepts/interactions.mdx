...
Uzay has a built-in interaction system that lets users drag, click, and hover over objects in the scene. Some objects (like points and vectors) come with default drag behavior, but you can also attach your own event handlers to any object.
