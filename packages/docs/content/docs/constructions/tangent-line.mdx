...
A `tangentLine` draws the tangent to a [parametric curve](/docs/items/parametric) at a given parameter value $t$. It creates a point on the curve and a line segment aligned with the derivative direction. Useful for:
